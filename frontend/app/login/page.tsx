  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10 space-y-6">
        {/* Brand Logo Header matching Screenshot 4 */}
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200/80 p-8 space-y-6">
          ...
          {/* Preset Demo Accounts for Easy Evaluation */}
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <div className="font-bold text-slate-800 flex items-center gap-1">
                  <CheckCircle2 className="w-3.5 h-3.5 text-crimson" /> Thí sinh
                </div>
                <div className="text-[10px] text-slate-500">Nguyễn Cường</div>
              </button>
